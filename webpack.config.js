...
const config = env => {
  console.log(env);
  var { vizSettings } = require("./src/js/projects/" +
    env.project +
    "/settings.js");
  ...
  return {
    entry:
      env.NODE_ENV === "development"
        ? PROJECT_DIR + "/js/index-dev.js"
        : PROJECT_DIR + "/js/index.js",
    output: {
      path: BUILD_DIR,
    ...
    resolve: {
      ...
      alias: {
        ...
        "mapbox-gl-geocoder": path.resolve(
          "./node_modules/mapbox-gl/plugins/src/mapbox-gl-geocoder/v2.0.1/"
        )
      }
    },
    devtool:
      env.NODE_ENV === "development" ? "cheap-module-eval-source-map" : "eval",
    devServer: {
      contentBase: "./"
    },
    module: {
