...
let vizSettings = {
	...
	"drone-strikes__libya__strike-totals-by-belligerent": {
		...
		vizType: "table",
		tableVars: [ variables.belligerent, variables.lb_total_munitions, variables.lb_total_strikes, variables.lb_civilians_lowhigh, variables.lb_militants_lowhigh, variables.lb_total_lowhigh],
		defaultOrdering: [0, "desc"],
		pagination: false,
		numPerPage: 10,
		colorScaling: false,
