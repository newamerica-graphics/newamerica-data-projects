...
let variables = {
	...
	incidents_anti_construction: {"variable":"incidents_anti_construction", "displayName":"Opposition to Mosques, Muslim Cemeteries & Schools", "category": "Total Incident Counts", "format": "number", "filterVal": "Opposition to Mosques, Muslim Cemeteries & Schools","scaleType": "quantize", "numBins":2, "customRange":[colors.white, colors.brown.light, colors.brown.dark]},
	incidents_elected_official: {"variable":"incidents_elected_official", "displayName":"Anti-Muslim Actions & Statements by Elected & Appointed Officials", "category": "Total Incident Counts", "format": "number", "filterVal": "Anti-Muslim Actions & Statements by Elected & Appointed Officials","scaleType": "quantize", "numBins":3, "customRange":[colors.white, colors.red.light, colors.red.dark]},
	incidents_hate: {"variable":"incidents_hate", "displayName":"Media Reports of Anti-Muslim Violence & Crimes", "category": "Total Incident Counts", "format": "number", "filterVal": "Media Reports of Anti-Muslim Violence & Crimes","scaleType": "quantize", "numBins":5, "customRange":[colors.white, colors.blue.light, colors.blue.dark]},
	per_capita_total: {"variable":"per_capita_total", "displayName":"All Incidents", "altLegendTitle":"All Incidents (Per 1 Million People)", "category": "Per Capita", "format": "number_with_decimal_2", "filterVal": null, "scaleType": "quantize", "numBins":5, "customRange":[colors.white, colors.turquoise.light, colors.turquoise.dark]},
	per_capita_anti_sharia: {"variable":"per_capita_anti_sharia", "displayName":"Anti-Sharia Legislation", "altLegendTitle": "Anti-Sharia Legislation (Per 1 Million People)", "category": "Per Capita", "format": "number_with_decimal_2", "filterVal": "Anti-Sharia Legislation","scaleType": "quantize", "numBins":5, "customRange":[colors.white, colors.orange.light, colors.orange.dark]},
	per_capita_anti_refugee: {"variable":"per_capita_anti_refugee", "displayName":"Opposition to Refugee Resettlement", "altLegendTitle": "Opposition to Refugee Resettlement (Per 1 Million People)", "category": "Per Capita", "format": "number_with_decimal_2", "filterVal": "Opposition to Refugee Resettlement","scaleType": "quantize", "numBins":5, "customRange":[colors.white, colors.purple.light, colors.purple.dark]},
	per_capita_anti_construction: {"variable":"per_capita_anti_construction", "displayName":"Opposition to Mosques, Muslim Cemeteries & Schools", "altLegendTitle": "Opposition to Mosques, Muslim Cemeteries & Schools (Per 1 Million People)", "category": "Per Capita", "format": "number_with_decimal_2", "filterVal": "Opposition to Mosques, Muslim Cemeteries & Schools","scaleType": "quantize", "numBins":5, "customRange":[colors.white, colors.brown.light, colors.brown.dark]},
	per_capita_elected_official: {"variable":"per_capita_elected_official", "displayName":"Anti-Muslim Actions & Statements by Elected & Appointed Officials", "altLegendTitle": "Anti-Muslim Actions & Statements by Elected & Appointed Officials (Per 1 Million People)", "category": "Per Capita", "format": "number_with_decimal_2", "filterVal": "Anti-Muslim Actions & Statements by Elected & Appointed Officials","scaleType": "quantize", "numBins":5, "customRange":[colors.white, colors.red.light, colors.red.dark]},
	per_capita_hate: {"variable":"per_capita_hate", "displayName":"Media Reports of Anti-Muslim Violence & Crimes", "altLegendTitle": "Media Reports of Anti-Muslim Violence & Crimes (Per 1 Million People)", "category": "Per Capita", "format": "number_with_decimal_2", "filterVal": "Media Reports of Anti-Muslim Violence & Crimes","scaleType": "quantize", "numBins":5, "customRange":[colors.white, colors.blue.light, colors.blue.dark]},
	...
	per_capita_muslim_anti_refugee: {"variable":"per_capita_muslim_anti_refugee", "displayName":"Opposition to Refugee Resettlement", "format": "number_with_decimal_2", "filterVal": "Opposition to Refugee Resettlement","scaleType": "quantize", "numBins":5, "customRange":[colors.white, colors.purple.light, colors.purple.dark]},
	per_capita_muslim_anti_construction: {"variable":"per_capita_muslim_anti_construction", "displayName":"Opposition to Mosques, Muslim Cemeteries & Schools", "format": "number_with_decimal_2", "filterVal": "Opposition to Mosques, Muslim Cemeteries & Schools","scaleType": "quantize", "numBins":5, "customRange":[colors.white, colors.brown.light, colors.brown.dark]},
	per_capita_muslim_elected_official: {"variable":"per_capita_muslim_elected_official", "displayName":"Anti-Muslim Actions & Statements by Elected & Appointed Officials", "format": "number_with_decimal_2", "filterVal": "Anti-Muslim Actions & Statements by Elected & Appointed Officials","scaleType": "quantize", "numBins":5, "customRange":[colors.white, colors.red.light, colors.red.dark]},
...
const preProcessData = (data) => {
	...
	data.incidents.map(d => {
		...
		d.sources_combined = combineSources([d.source1_url, d.source1_display_name, d.source2_url, d.source2_display_name, d.source3_url, d.source3_display_name, d.source4_url, d.source4_display_name])
