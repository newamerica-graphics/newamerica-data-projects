...
let variables = {
	...
	per_capita_total: {"variable":"per_capita_total", "displayName":"All Incidents (Per 100,000 People)", "category": "Per Capita", "format": "number_with_decimal_2", "filterVal": null, "scaleType": "quantize", "numBins":5, "customRange":[colors.white, colors.turquoise.light, colors.turquoise.dark]},
	per_capita_anti_sharia: {"variable":"per_capita_anti_sharia", "displayName":"Anti-Sharia Legislation (Per 100,000 People)", "category": "Per Capita", "format": "number_with_decimal_2", "filterVal": "Anti-Sharia Legislation","scaleType": "quantize", "numBins":5, "customRange":[colors.white, colors.orange.light, colors.orange.dark]},
	per_capita_anti_refugee: {"variable":"per_capita_anti_refugee", "displayName":"Opposition to Refugee Resettlement (Per 100,000 People)", "category": "Per Capita", "format": "number_with_decimal_2", "filterVal": "Opposition to Refugee Resettlement","scaleType": "quantize", "numBins":5, "customRange":[colors.white, colors.purple.light, colors.purple.dark]},
	per_capita_anti_construction: {"variable":"per_capita_anti_construction", "displayName":"Opposition to Mosques, Muslim Cemeteries & Schools (Per 100,000 People)", "category": "Per Capita", "format": "number_with_decimal_2", "filterVal": "Opposition to Mosques, Muslim Cemeteries & Schools","scaleType": "quantize", "numBins":5, "customRange":[colors.white, colors.brown.light, colors.brown.dark]},
	...
	per_capita_hate: {"variable":"per_capita_hate", "displayName":"Media Reports of Anti-Muslim Violence & Crimes (Per 100,000 People)", "category": "Per Capita", "format": "number_with_decimal_2", "filterVal": "Media Reports of Anti-Muslim Violence & Crimes","scaleType": "quantize", "numBins":5, "customRange":[colors.white, colors.blue.light, colors.blue.dark]},
