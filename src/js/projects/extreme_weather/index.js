...
let variables = {
	...
	intro_fips: {"variable":"fips", "displayName":"County Fips", "format":"number"},
	intro_value: {"variable":"value", "displayName":"Value", "format":"string", "scaleType":"categorical", "customDomain":["0", "1"], "customRange":["white", colors.turquoise.light]},
}
...
let vizSettingsList = [
	...
	// },
	{
		id: "#extreme-weather__intro-map", 
		vizType: "topo_json_map",
		primaryDataSheet: "intro_map",
		geometryType: "counties",
		stroke: {"color": "grey", "width":".5", "opacity": ".6", "hoverColor": colors.black, "hoverWidth": "2"},
		geometryVar: variables.intro_fips,
		filterVars: [variables.intro_value],
		// tooltipVars: [variables.fema_county_name, variables.fema_fire],
