...
let variables = {
	...
	placeholder_val: {"variable":"placeholder_val", "displayName":"Article", "format": "string", "category": "Article", "canSplitCategory":true, "scaleType": "categorical", "customDomain":["No Article Written", "Article Available"], "customRange":[colors.turquoise.light, colors.turquoise.dark]},
	is_go: {"variable":"is_go", "displayName":"District Type", "format": "string"},
	dist_enroll: {"variable":"dist_enroll", "displayName":"District Enrollment", "format": "integer"},
	comm_type: {"variable":"comm_type", "displayName":"Community Type", "format": "string"},
...
let vizSettings = {
	"open-ed-resources__districts": {
		...
		tooltipVars: [ variables.district, variables.state, variables.grade_level_band, variables.content_area, variables.dist_enroll, variables.is_go, variables.comm_type, variables.has_link],
...
module.exports = {
	...
	dataUrl: "http://na-data-projects.s3.amazonaws.com/data/edpolicy/open-ed-resources-test.json",
