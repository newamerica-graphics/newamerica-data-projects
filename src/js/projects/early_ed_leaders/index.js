...
let vizSettingsList = [
	{
		id: "#early-ed-leaders__combined-map", 
	...
	},
	{
		...
		geometryVar: variables.state_id,
		stroke: {"color": colors.white, "width":"1", "opacity": "1", "hoverColor": colors.white, "hoverWidth": "3"},
		filterVars: [ variables.min_ed_requirement, variables.license_grade_span, variables.higher_ed_coursework, variables.clinical_experience, variables.prior_teaching_experience],
		tooltipVars: [ variables.state, variables.min_ed_requirement, variables.license_grade_span, variables.higher_ed_coursework, variables.clinical_experience, variables.prior_teaching_experience],
		legendSettings: {"orientation": "vertical-right", "showTitle": true},
		filterGroupSettings: {"hidden": false},
	},
	{
		...
		geometryVar: variables.state_id,
		stroke: {"color": colors.white, "width":"1", "opacity": "1", "hoverColor": colors.white, "hoverWidth": "3"},
		filterVars: [ variables.professional_learning, variables.joint_professional_learning, variables.formal_evaluation],
		tooltipVars: [ variables.state, variables.professional_learning, variables.joint_professional_learning, variables.formal_evaluation],
		legendSettings: {"orientation": "vertical-right", "showTitle": true},
		filterGroupSettings: {"hidden": false},
	},
	{
		...
		geometryVar: variables.state_id,
		stroke: {"color": colors.white, "width":"1", "opacity": "1", "hoverColor": colors.white, "hoverWidth": "3"},
		filterVars: [ variables.track_principal_turnover, variables.avg_salary, variables.benefits, variables.diversity_incentives ],
		tooltipVars: [ variables.state, variables.track_principal_turnover, variables.avg_salary, variables.benefits, variables.diversity_incentives ],
		legendSettings: {"orientation": "vertical-right", "showTitle": true},
		filterGroupSettings: {"hidden": false},
	},
	{
	...
	{
		id: "#early-ed-leaders__diversity-incentives", 
		vizType: "category_breakdown",
		primaryDataSheet: "principals",
		dotSettings: { "width": 30, "offset": 5},
		filterVars: [ variables.diversity_incentives ],
		labelVar: variables.state_abbrev,
		tooltipVars: [ variables.state ],
	},
