...
let variables = {
	...
	higher_ed_coursework: {"variable":"higher_ed_coursework", "displayName":"ECE Coursework", "format": "string", "category":"Principals", "scaleType":"categorical", "canSplitCategory":true, "customDomain":["Must Offer Early Learning Coursework","Must Offer Child Development Coursework", "No", "No data"], "customRange":[colors.turquoise.light, colors.blue.medium, colors.red.medium, colors.grey.medium]},
	...
	professional_learning: {"variable":"professional_learning", "displayName":"ECE Professional Learning", "format": "string", "category":"Principals", "scaleType":"categorical", "customDomain":["Yes", "No", "No data"], "customRange":[colors.turquoise.medium, colors.red.medium, colors.grey.medium]},
	joint_professional_learning: {"variable":"joint_professional_learning", "displayName":"Joint Professional Learning", "format": "string", "category":"Principals", "scaleType":"categorical", "customDomain":["Yes", "No", "No data"], "customRange":[colors.turquoise.medium, colors.red.medium, colors.grey.medium]},
	formal_evaluation: {"variable":"formal_evaluation", "displayName":"Formal Evaluation", "format": "string", "category":"Principals", "scaleType":"categorical", "customDomain":["Yes", "No", "No data"], "customRange":[colors.turquoise.medium, colors.red.medium, colors.grey.medium]},
	track_principal_turnover: {"variable":"track_principal_turnover", "displayName":"Track Principal Turnover", "format": "string", "category":"Principals", "scaleType":"categorical", "customDomain":["Yes", "Yes (starting to)", "No", "No data"], "customRange":[colors.turquoise.medium, colors.turquoise.light, colors.red.medium, colors.grey.medium]},
	...
	benefits: {"variable":"benefits", "displayName":"Benefits", "format": "string", "category":"Principals", "scaleType":"categorical", "canSplitCategory":true, "customDomain":["Health Insurance, Pension/Retirement, and Paid Sick Leave", "Health Insurance and Pension/Retirement - No Paid Sick Leave", "Unknown/Data Not Available"], "customRange":[colors.turquoise.medium, colors.blue.medium, colors.grey.medium]},
	diversity_incentives: {"variable":"diversity_incentives", "displayName":"Diversity Incentives", "format": "string", "category":"Principals", "scaleType":"categorical", "canSplitCategory":true, "customDomain":["Financial Incentives", "Supports in Place", "No", "No data"], "customRange":[colors.turquoise.light, colors.blue.medium, colors.red.medium, colors.grey.medium]},
	...
	cd_credential_required_for_licensing: {"variable":"cd_credential_required_for_licensing", "displayName":"Credential Required for Licensing", "format": "string", "category":"Center Directors", "scaleType":"categorical", "customDomain":["Yes", "No", "N/A"], "customRange": [colors.turquoise.medium, colors.red.medium, colors.grey.medium]},
	cd_credential_source: {"variable":"cd_credential_source", "displayName":"Credential Source", "format": "string", "category":"Center Directors"},
	cd_qris_different_tiers: {"variable":"cd_qris_different_tiers", "displayName":"QRIS Ties to Different Tiers", "format": "string", "category":"Center Directors", "scaleType":"categorical", "customDomain":["Yes", "No", "N/A"], "customRange": [colors.turquoise.medium, colors.red.medium, colors.grey.medium]},
