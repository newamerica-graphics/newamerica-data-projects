...
let variables = {
	...
	higher_ed_coursework: {"variable":"higher_ed_coursework", "displayName":"Higher Ed Coursework", "format": "string", "category":"Pre-Service", "scaleType":"categorical", "customDomain":["Must Offer Early Learning Coursework","Must Offer Child Development Coursework", "No", "No data"], "customRange":[colors.turquoise.medium, colors.blue.medium, colors.red.medium, colors.grey.light]},
