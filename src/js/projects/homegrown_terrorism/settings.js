...
let variables = {
  year_charged_or_deceased: {
    variable: "year_charged_or_deceased",
    displayName: "Year",
    format: "year",
  ...
  charged_or_deceased: {
    variable: "charged_or_deceased",
    displayName: "Charged or Deceased",
    format: "string",
    scaleType: "categorical",
    color: "blue",
    customDomain: ["Charged", "Charged outside U.S.", "Deceased"],
    customRange: [
  ...
  date_charged: {
    variable: "date_charged",
    displayName: "Date Charged",
    format: "string"
  },
  terror_plot: {
    variable: "terror_plot",
    displayName: "Terror Plot",
    format: "string"
  },
  citizenship_status: {
    variable: "citizenship_status",
    ...
    customDomain: [
      "U.S. Born Citizen",
      "Naturalized Citizen",
      "Citizen of Unknown Status",
      "Permanent Resident",
      "Nonimmigrant Visa",
      "Visa-Free Travel Eligible Individual",
      "Illegal Immigrant",
  ...
  field_convert: {
    ...
    format: "string",
    scaleType: "categorical",
    customDomain: ["Convert", "Muslim Non-Convert", "Not Muslim", "Unknown"],
    customRange: [
      colors.turquoise.light,
      colors.blue.medium,
  ...
  char_awlaki: {
    variable: "char_awlaki",
    displayName: "Involvement with Awlaki",
    format: "string",
    scaleType: "categorical",
    customDomain: ["Ties", "Contact", "None"],
    customRange: [
      colors.red.light,
      colors.purple.light,
      colors.grey.medium_light
  ...
  gender: {
    ...
    scaleType: "categorical",
    color: "red",
    customDomain: ["Female", "Male"],
    customRange: [colors.red.light, colors.turquoise.light]
  },
  field_year_indicted: {
    variable: "field_year_indicted",
    displayName: "Field Indicted",
    format: "year",
    scaleType: "categorical",
    color: "blue"
  },
  online_radicalization: {
    variable: "char_online_radicalization",
    displayName: "Yearly Cases Involving Online Radicalization",
    format: "percent",
    color: colors.blue.dark
  },
  headshot: { variable: "headshot", format: "image" },
  inv_informant: { variable: "inv_informant", format: "string" },
  inv_community_or_family_tip: {
    variable: "inv_community_or_family_tip",
    format: "string"
  },
  inv_public_tip: { variable: "inv_public_tip", format: "string" },

  deadly_attack_date: {
    variable: "deadly_attack_date",
    displayName: "Deadly Attack Date",
    format: "date"
  },
  victims_killed: {
    variable: "victims_killed",
    displayName: "Victims Killed",
    format: "number"
  },
  victims_wounded: {
    variable: "victims_wounded",
    displayName: "Victims Wounded",
    format: "string"
  },
  ideology: {
    variable: "ideology",
...
let vizSettings = {
  "homegrown__outcome-for-extremist": {
    ...
    chartSettings: {
      ...
      tooltipVars: [
        variables.full_name,
        variables.charged_or_deceased,
        variables.date_charged,
        variables.terror_plot
      ],
    ...
    factBoxSettings: {
      ...
      factBoxVals: [
        {
          variable: variables.charged_or_deceased,
          value: "Charged",
          type: "count",
          text: "Charged"
        },
        {
          variable: variables.charged_or_deceased,
          value: "Charged outside U.S.",
          type: "count",
          text: "Charged outside U.S."
        },
        {
          variable: variables.charged_or_deceased,
          value: "Deceased",
  ...
  "homegrown__awlaki-over-time": {
    ...
    dividingLine: {
      value: "2011",
      title: "Post al-Awlaki",
      descriptionLines: [
        "Anwar al-Awlaki killed in drone strike on",
        "September 30, 2011"
      ]
    },
  ...
  "homegrown__citizenship-status": {
    ...
    tooltipImageVar: variables.headshot,
    split: {
      splitFilterVar: variables.citizenship_status,
      splitVal: "Permanent Resident",
      leftLabel: "Citizens and Permanent Residents",
      rightLabel: "Non-residents and Unknown",
      splitAggregate: "percent"
    },
  ...
  "homegrown__convert-status": {
    ...
    tooltipImageVar: variables.headshot,
    split: {
      splitFilterVar: variables.field_convert,
      splitVal: "Muslim Non-Convert",
      leftLabel: "Muslims",
      rightLabel: "Non-Muslims and Unknown",
      splitAggregate: "count"
    },
    legendSettings: {
      orientation: "horizontal-center",
      showValCounts: true,
  ...
  "homegrown__age-of-extremists": {
    ...
    factBoxSettings: {
      ...
      factBoxVals: [
        ...
        {
          variable: variables.marital_status,
          value: "Married",
          type: "percent",
          text: "Married"
        }
  ...
  "homegrown__fact-box__method-of-radicalization": {
    ...
    factBoxVals: [
      {
        variable: variables.online_radicalization,
        value: "Yes",
        type: "percent",
        color: colors.turquoise.light,
        text:
          "Maintained a social media profile with jihadist material or utilized encryption for plotting"
      }
    ]
  },
  "homegrown__deadly-attacks": {
    ...
    tooltipVars: [
      variables.attack_name,
      variables.ideology,
      variables.victims_wounded,
      variables.victims_killed,
      variables.attack_description
    ],
  ...
  "homegrown__fact-box__prevention-method": {
    ...
    factBoxVals: [
      {
        variable: variables.inv_informant,
        value: "Yes",
        type: "percent",
        color: colors.turquoise.light,
        text: "Percent of jihadists monitored by an informant"
      },
      {
        variable: variables.inv_community_or_family_tip,
        value: "Yes",
        type: "percent",
        color: colors.blue.light,
        text:
          "Percent of jihadists implicated by a tip from family members or the community"
      },
      {
        variable: variables.inv_public_tip,
        value: "Yes",
        type: "percent",
        color: colors.purple.light,
        text: "Percent of jihadists implicated by a tip from the general public"
      }
    ]
  },
      ...
      factBoxVals: [
        {
          ...
          value: "Yes",
          type: "percent",
          text: "Total Percent Radicalized Online"
        }
      ]
    }
  },
...
module.exports = {
  ...
  dataUrl:
    "https://na-data-projects.s3.amazonaws.com/data/isp/homegrown_extremism.json",
  downloadableSheets: ["people_protected", "origins", "terror_plots"]
};
