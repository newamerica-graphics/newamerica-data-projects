...
let variables = {
  medhhinc: {
    ...
    format: "price",
    scaleType: "quantize",
    customDomain: [0, 37500, 75000, 112500, 150000],
    customRange: [
      "rgb(247, 247, 247)",
      "rgb(238, 238, 239)",
      "rgb(196, 197, 199)",
  ...
  minority: {
    ...
    format: "percent_no_multiply",
    scaleType: "quantize",
    customDomain: [0, 15, 30, 45, 60],
    customRange: [
      "rgb(247, 247, 247)",
      "rgb(238, 238, 239)",
      "rgb(196, 197, 199)",
  ...
  fampov: {
    variable: "FAMPOV",
    displayName: "Families Below Poverty Line (%)",
    format: "percent_no_multiply",
    scaleType: "quantize",
    customDomain: [0, 10, 20, 30, 40],
    customRange: [
      "rgb(247, 247, 247)",
      "rgb(238, 238, 239)",
      "rgb(196, 197, 199)",
  ...
  medval: {
    variable: "MEDVAL",
    displayName: "Median Value of Owner-Occupied Units",
    format: "price",
    scaleType: "quantize",
    customDomain: [0, 150000, 300000, 450000, 600000],
    customRange: [
      "rgb(247, 247, 247)",
      "rgb(238, 238, 239)",
      "rgb(196, 197, 199)",
  ...
  ncua: {
    variable: "ncua",
    displayName: "Credit Unions",
    format: "number",
    color: "#9773c7"
  },
  usps: {
    variable: "usps",
    displayName: "Post Offices",
    format: "number",
    color: "#fdcb6d"
  },
  totpop: {
  ...
  asian: {
    variable: "ASIAN",
    displayName: "Asian/Native Hawaiian/Other Pacific Islander",
    format: "percent_no_multiply"
  },
  tworace: {
    variable: "TWORACE",
  ...
  moneyorder: {
    variable: "moneyorder",
    displayName: "Money Orders",
    format: "number"
  },
  payday: {
    variable: "payday",
    displayName: "Payday, Installment, and Other Alternative Loans",
    format: "number"
  },
  titleloan: {
    variable: "titleloan",
    displayName: "Auto and Other Title Loans",
    format: "number"
  },
  pawn: {
    variable: "pawn",
    displayName: "Pawnbrokers and Furniture Rentals",
    format: "number"
  },
  tax: {
    variable: "tax",
    displayName: "Tax Return and Filing Services",
    format: "number"
  },
  irsVita: {
    variable: "irs-vita",
    displayName: "IRS-VITA",
    format: "number",
    color: "#f2e079"
  },
  bankon: {
    variable: "bankon",
    displayName: "Bank On City",
    format: "number",
    color: "#fca849"
  },
  cdfi: {
  ...
  county_altper10k2: {
    variable: "altper10k2",
    displayName: "Alt. Financial Services Per 10,000 People",
    ...
    customLabels: ["Very Low", "Low", "Average", "High", "Very High"],
    numBins: 5
  },
  county_tradpc: {
    variable: "tradpc",
    displayName: "Mainstream Financial Services Per 10,000 People",
    format: "number_per_ten_thousand",
    customDomain: [
      0,
      0.00040351325541044023,
      0.0006645722571290479,
  ...
  county_altpertrd2: {
    variable: "altpertrd2",
    displayName: "Ratio of Alt. Financial Services to Mainstream",
    format: "number_with_decimal_2",
    customDomain: [0, 0.433333333333, 0.966666666667, 1.68421052632, 3],
    customRange: [
      "rgb(154, 186, 167)",
      "rgb(189, 201, 149)",
      "rgb(224, 216, 130)",
...
let vizSettings = {
  "financial-opportunity__census-tract-map": {
    ...
    mapboxStyleUrl:
      "mapbox://styles/newamericamapbox/civcm5ziy00d92imrwswlo1wv",
    source: {
      id: "census-tracts",
  ...
  "financial-opportunity__county-map": {
    vizType: "financial_opportunity_map",
    mapboxStyleUrl:
      "mapbox://styles/newamericamapbox/ciwdu1mzs003j2pmq94myzf8q",
    source: {
      id: "counties",
      sourceLayer: "CountydataRevised-al6t9k",
      url: "mapbox://newamericamapbox.95xz8p1q"
    },
    additionalLayers: [
      variables.county_altpertrd2,
      variables.county_altper10k2,
      variables.county_tradpc
    ],
    filters: [
      {
        filterVars: [
  ...
  "financial-opportunity__census-tract-map-other-services": {
    vizType: "financial_opportunity_map",
    mapboxStyleUrl:
      "mapbox://styles/newamericamapbox/cixql9hl200762rp5qynmxcfe",
    source: {
      id: "census-tracts",
      sourceLayer: "CensusTracts_2014data2K_2-3r3ays",
      url: "mapbox://newamericamapbox.7zun44wf"
...
function censusTractMapSetPopupContent(feature) {
  ...
  for (let key in this.tooltipVars) {
    ...
    popupProperties +=
      ...
      "<h5 class='mapbox-map__popup__category-label'>" +
      key +
      "</h5>" +
    ...
    for (let i = 0; i < values.length; i++) {
      ...
      popupProperties +=
        "<li class='mapbox-map__popup__property'>" +
        "<h5 class='mapbox-map__popup__property__label'>" +
        currVar.displayName +
        "</h5>" +
        "<h5 class='mapbox-map__popup__property__value'>" +
        formatValue(feature.properties[currVar.variable], currVar.format) +
        "</h5>" +
        "</li>";
    }
  ...
  tradTotal +=
    feature.properties[variables.bank2014.variable] +
    feature.properties[variables.ncua2014.variable];

  altTotal +=
    feature.properties[variables.checkcash.variable] +
  ...
  return (
    "<h5 class='mapbox-map__popup__subheading'>" +
    splitPieces[2] +
    "</h5>" +
    "<h3 class='mapbox-map__popup__heading'>" +
    splitPieces[1] +
    "</h3>" +
    "<h5 class='mapbox-map__popup__subheading'>" +
    splitPieces[0] +
