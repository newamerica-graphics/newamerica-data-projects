...
let variables = {
	...
	students_funding: {"variable":"students", "displayName":"Funding from Students", "format": "percent", color:colors.turquoise.light},
	states_funding: {"variable":"states", "displayName":"Funding from States", "format": "percent", color:colors.turquoise.light},
	federal_funding: {"variable":"federal", "displayName":"Funding from Federal Govt.", "format": "percent", color:colors.blue.dark},
...
let vizSettings = {
	"varying-degrees__students-funding": {
		...
		primaryDataSheet: "funding_revised",
	...
	"varying-degrees__government-funding": {
		...
		primaryDataSheet: "funding_revised",
		groupingVar: variables.sector,
		filterVars: [ variables.states_funding, variables.federal_funding ],
		aggregateData: false,
		showLegend: true
	},
	"varying-degrees__avg-student-age": {
		...
		simpleDataVals: true,
		eventSettings: {
			"mouseover":{ "tooltip": false, "fill": false, "stroke": "white", "strokeWidth": 0},
		}
	},
